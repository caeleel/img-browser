...
export default function TopBar({ onPrevious, onNext, onClose, toggleFullscreen, setShowInfo, image, showFilmstrip, idx, total, isFullscreen }: {
  onPrevious?: () => void,
  onNext?: () => void,
  onClose: () => void,
  ...
  return <div className={`fixed rounded-lg shadow-md z-10 h-9 right-2 backdrop-blur-md bg-black/80 px-2 overflow-hidden duration-300 flex items-center justify-between text-white ${showFilmstrip ? 'top-2' : '-top-16'}`}>
